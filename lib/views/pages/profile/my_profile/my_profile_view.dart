...
class MyProfileView extends ConsumerWidget {
                      ...
                      Align(
                        ...
                        child: CircleAvatar(
                          ...
                          child: ClipRRect(
                            ...
                            child: mpvm.intro == null
                                ? Image.asset(
                                    "assets/images/generic-avatar.svg")
                                : Image.memory((Uri.parse(mpvm?.photo ??
  ...
  Widget _buildCircleAvatar(mpvm) {
    return Center(
      child: CircleAvatar(
        radius: 70,
        backgroundImage: mpvm.intro!.isEmpty
            ? AssetImage("assets/images/generic-avatar.svg")
            : AssetImage("assets/images/76.jpg"),
      ),
    );
  }
