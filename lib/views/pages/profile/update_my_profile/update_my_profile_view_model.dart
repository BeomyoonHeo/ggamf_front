...
final updateMyProfileViewModel =
    StateNotifierProvider<UpdateMyProfileViewModel, ProfileUser>((ref) {
...
class UpdateMyProfileViewModel extends StateNotifier<ProfileUser> {
  ...
  void updateMyProfile(ProfileUser profileUser) {
    ProfileUserRepository restApi = ProfileUserRepository(dio);
    restApi.putUserProfile(id: 1, profileUser: profileUser).then((value) =>
        state = ProfileUser(
            photo: value.photo, nickname: value.nickname, intro: value.intro));
  }
