        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  InputBox(inputText: "이름 : ", hintText: "이름을 입력하세요", controller: nameController),
                  const SizedBox(height: 10),
                  InputBox(inputText: "아이디 : ", hintText: "아이디를 입력하세요", controller: idController),
                  const SizedBox(height: 10),
                  InputBox(inputText: "비밀번호 : ", hintText: "비밀번호를 입력하세요", controller: passwordController),
                  const SizedBox(height: 10),
                  InputBox(inputText: "비밀번호 확인 : ", hintText: "비밀번호를 입력하세요", controller: null),
                  const SizedBox(height: 10),
